...
public class pagina_client {
    ...
    public static void inicializa() {
        ...
        rowCount = ((miniSimpleTableModel_Client) modules.users.client.view.Client.jTable_Client.getModel()).getRowCount();
    ...
    public static void initLinkBox() {
        ...
        modules.users.client.controller.controller_Client.sorter.setRowFilter(new RowFilter<TableModel, Integer>() {
            @Override
        ...
        if ((rowCount <= itemsPerPage) && (rowCount > 0)) { //caben todos los datos en la misma página
            ...
            modules.users.client.view.Client.primero.setEnabled(false);
            modules.users.client.view.Client.ANTERIOR.setEnabled(false);
            modules.users.client.view.Client.SIGUIENTE.setEnabled(false);
            modules.users.client.view.Client.ultimo.setEnabled(false);
            modules.users.client.view.Client.CAJA.setText("");
            ...
            modules.users.client.view.Client.primero.setEnabled(currentPageIndex > 1);
            modules.users.client.view.Client.ANTERIOR.setEnabled(currentPageIndex > 1);
            modules.users.client.view.Client.SIGUIENTE.setEnabled(currentPageIndex < maxPageIndex);
            modules.users.client.view.Client.ultimo.setEnabled(currentPageIndex < maxPageIndex);
            modules.users.client.view.Client.CAJA.setText(Integer.toString(currentPageIndex) + String.format(" / %d", maxPageIndex));
